      ...
      <div className="userProfileContainer">
        <div className="profile">
          <div className="userImg"> 
            <img src={preview || (selectedUser ? `https://phpstack-1252920-4618688.cloudwaysapps.com/img/${selectedUser.image}` : userImg) || userPlaceholder} alt="User" />
          ...
          <div>
            <h3 className="userName">{selectedUser.firstname} {selectedUser.lastname}</h3> 
        ...
        <div className="userStat"> 
          <div className="content">
            <div className="info">
              <h2><span><i className="fa fa-envelope"></i></span> {selectedUser.username}</h2>
            </div>
          </div>
        </div> 
      </div>
